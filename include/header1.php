...
<body>
    ...
    <header>
        ...
        <div class="right_area">
            ...
            <a style="" class="logout_btn1" href="#"><?php echo $_SESSION['email'] ?></a>
        </div>
    </header>
    ...
    <div class="sidebar">
        ...
        <a href="home.php"><i class="fas fa-th <?php if($page=='home'){echo 'active';} ?>"><span>Forms</span></i></a>
        <a href="home.php"><i class="fas fa-info-circle <?php if($page=='home'){echo 'active';} ?>"><span>About</span></i></a>
