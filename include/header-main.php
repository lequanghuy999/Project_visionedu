...
<div id="header">
      ...
      <nav class="bottom-header">
        <ul>
         ...
         <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal">Admin Login</button>
         ...
         <div style="color:#fff;" class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog">
               <div class="modal-content">
                  <div style="background: linear-gradient(to right, #cbb4d4, #20002c);" class="modal-header">
                  <p style="Color:#fff;" class="h3 modal-title" id="exampleModalLabel">Login for Admin</p>
                  <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                  </div>
                  <div class="modal-body" style="background-color:#a692ad;">
                  <div class="container">
                     <form action="index.php" method="post">
                        ...
                        <input style="background: linear-gradient(to right, #cbb4d4, #20002c); width:150px;" type="submit" name="submit" class="btn btn-primary" value="login">
                     </form>
                  </div>
                  </div>
                  <div class="modal-footer" style="background: linear-gradient(to right, #20002c, #cbb4d4);">
                  <button style="background: linear-gradient(to right, #20002c, #cbb4d4);" type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                  </div>
               </div>
            </div>
         </div>
